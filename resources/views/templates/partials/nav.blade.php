    ...
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="flex flex-col p-4 mt-4 bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:font-medium md:border-0 md:bg-white">
                ...
                <li>
                    <a href="{{ route('berita') }}" class="{{ ($title === "Berita") ? 'md:bg-transparent md:text-[#2EB5F8] bg-[#2EB5F8] text-white' : '' }} block py-2 pl-3 pr-4 text-gray-500 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-[#2EB5F8] md:p-0">
                        Berita Desa
                    </a>
                </li>
                <li>
